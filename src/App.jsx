  ...
  const handleFileUpload = (e) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        const idxTTComis = cleanHeaders.findIndex(h => h.includes('tt comis') || h.includes('total comis') || h === 'comis imp');
        const idxComis = cleanHeaders.findIndex(h => h === 'comision' || h === 'comis' || h === 'comis.');

        const idxTTFlete = cleanHeaders.findIndex(h => h.includes('tt freight') || h.includes('tt flete') || h.includes('total flete') || h.includes('total freight') || h === 'tt fc');
        ...
        const idxTTOtros = cleanHeaders.findIndex(h => h.includes('tt others') || h.includes('tt otros') || h.includes('total otros') || h === 'tt oc');
